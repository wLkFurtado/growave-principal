...
export default function Pricing({ openModal }) {
  ...
  return (
    <section style={{ padding: isMobile ? '48px 16px 64px' : '80px 40px 100px', maxWidth: 900, margin: '0 auto' }}>
      <div style={{
        background: '#111', border: '1px solid rgba(74,255,90,0.20)',
      ...
      >
        <div style={{
          ...
          color: '#4AFF5A', padding: '4px 12px', borderRadius: '0 0 10px 10px',
          fontFamily: 'JetBrains Mono', fontSize: 9, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase',
        }}>Exclusivo</div>

        <h2 style={{
          fontFamily: 'Bebas Neue', fontSize: isMobile ? 48 : 72,
          letterSpacing: '0.08em', textTransform: 'uppercase', color: '#4AFF5A',
          marginBottom: isMobile ? 16 : 28,
          filter: 'drop-shadow(0 0 15px rgba(74,255,90,0.25))',
        }}>Investimento</h2>

        <p style={{
          fontFamily: 'Inter', fontSize: isMobile ? 15 : 18,
          color: 'rgba(234,234,234,0.9)', lineHeight: 1.7,
          maxWidth: 600, margin: isMobile ? '0 0 28px' : '0 auto 48px',
        }}>
        ...
        <h3 style={{
          fontFamily: 'Bebas Neue', fontSize: isMobile ? 24 : 40,
          letterSpacing: '0.06em', textTransform: 'uppercase', color: '#4AFF5A',
        ...
        <p style={{
          ...
          maxWidth: 560, margin: isMobile ? '0 0 28px' : '0 auto 40px',
        }}>
        ...
        <button className="ibtn" onClick={openModal} style={{
          ...
          fontSize: isMobile ? 17 : 22, letterSpacing: '0.08em', textTransform: 'uppercase',
          padding: isMobile ? '16px 20px' : '20px 52px', borderRadius: 9999,
          display: isMobile ? 'flex' : 'inline-flex', alignItems: 'center',
